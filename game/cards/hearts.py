...
disturb your ambitions. You are enraged by such a daring move against your person and vow to destroy them. You are still
bound by mortal passions, after all.""",
        "fixed_prompts": [
        ...
        "random_prompts": [
            RandomPrompt(
                ...
                [
                    ...
                    """A hateful letter written with poisonous ink distilled from the blood of an unknown creature.""",
...
infects the powerful and denounces old and oppressive institutions. You know they worship a false god, or at best
a minor entity of the spheres, and yet you find some utility in their nonsense. Impressionable individuals with
devotion to a higher purpose are the easiest to manipulate.""",
        "fixed_prompts": [
...
their own households finally provides results you can use. You learn political secrets well protected by steel and
incantations, and now you can plan ahead to profit from the bleak future to come, 
and even intrude to your advantage.""",
        "fixed_prompts": [
...
lurking in your unconscious thoughts.""",
        ...
        "random_prompts": [
            ...
            RandomPrompt(
                ...
                [
                    """Immovable doors opened by impossible riddles. The memory is carved in stone and written in
...
advisor of the holy emperor. Fear of rolling heads and dishonour makes them inclined to help you."""
                         ])
        ]
    },
    FaceValue.KING: {
...
influence, making your life difficult.""",
                             """Some of your secrets are stolen by skillful thieves,
