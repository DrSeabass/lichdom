...
moonless night. You are disturbed and impressed that they managed to bypass all your mundane and arcane precautions, and
you suspect they had help. Their admirable efforts, however, turned out to be fruitless when you sensed their presence
and found them within your tower. They had no escape, and so they died in terrible agony; their screams uttering
the name of whom you now seek with a vengeful heart.""",
        "fixed_prompts": [
        ...
        "random_prompts": [
            RandomPrompt("Who sent the thieves?",
                         [
                             """The Circle of Sequestered Mystics, 
collectors of ancient wonders that practice restraint in magic.""",
                             """The Mercantile Guild, who seeks profit above all else.""",
                             """Nobody. A thief with an ambition reaching further than his skills.
You like him, but failure has a price"""])
        ]
    },
    FaceValue.THREE: {
        "boiler_plate": """The vile abomination you created escaped from its foul pit of death. It killed and
consumed many of your servants in a rampage of hate, blood, and desperation. It was amusing at first, but you had
to finally kill it before it wrecked havoc beyond repair. The experiment can be considered a failure, as the creature
could not be controlled reliably to do your bidding, but at least you gained a wealth of non-sorcerous knowledge on
the inner workings of several species, alchemical concoctions,
        and surgery.""",
        "fixed_prompts": [
        ...
        "random_prompts": [
            RandomPrompt("Why did you create it?",
                         [
                             """To learn and understand secrets that could extend your own life in the future
through unnatural means.""",
                             """As a stealthy and faithful killer; a creature unclouded by conscience, remorse, or
delusions of morality to send against your enemies.""",
                             """To clone key powerful figures that you planned on supplanting by
your mind controlled puppets."""])
        ]
    },
    FaceValue.FOUR: {
        "boiler_plate":
            """The bloodthirsty heir of an old ruling dynasty has come to power by treachery and murder, and
you helped or failed to prevent it. Discontent spreads and revolution is imminent, but the iron fist of the new ruler
keeps the population in check with ruthless practices and well paid mercenaries, while the coffers of the kingdom are
wasted in bribes and steel.""",
        "fixed_prompts": [
...
They can’t openly move against their foes, and so they depend on your sorcery to achieve their ambitious goals.
Curses should not be used lightly, as you may call forces difficult to control, but either for your own benefit or
the pain of your common enemies, you decide to employ your dark arts to end a dynasty.""",
        "fixed_prompts": [
...
a long time, but never thought they would dare to openly move against you. Especially in such a crude way. You have no
option but to retaliate; but you won’t fail, and their screams will reverberate in the vaults and corridors of
your domain for many long days.""",
        "fixed_prompts": [
...
seeks you relentlessly carrying some protection against magic. Only powerful sorcery can help you to
defeat this enemy.""",
        "fixed_prompts": [
...
be useful in the mundane world of violence and threats you need to navigate before transcending to lichdom. But do not
get too attached, they are mortal and dispensable, after all.""",
        "fixed_prompts": [
            "What is their name?",
...
simple minded mortals, no more than a tool to be used and discarded in your quest for immortality. Peons on a game of
gods that have the power to decide who enslaves them.""",
        "fixed_prompts": [
